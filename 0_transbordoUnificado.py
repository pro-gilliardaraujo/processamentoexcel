...
=======
>>>>>>> 6b8e28cd5ec0b7d996ad916daaa06a5728ee0a5a
...
=======
        resultados.append({
            'Frota': str(equipamento),  # Garantir que seja texto
            'Frente': frente,
            'Disponibilidade': disp_mecanica
>>>>>>> 6b8e28cd5ec0b7d996ad916daaa06a5728ee0a5a
        })
...
=======
        'Frota': equipamentos_unicos['Equipamento'].astype(str).values,  # Garantir que seja texto
        'Frente': equipamentos_unicos['Frente'].values,
...
=======
                ...
                for row in range(2, worksheet.max_row + 1):
                    for col in range(1, worksheet.max_column + 1):  # Verificar todas as colunas
                        header = worksheet.cell(row=1, column=col).value
                        cell = worksheet.cell(row=row, column=col)
                        
                        # Não aplicar formatação numérica na coluna Frota ou Frente
                        if header not in ['Frota', 'Frente']:
>>>>>>> 6b8e28cd5ec0b7d996ad916daaa06a5728ee0a5a
                            cell.number_format = '0.00'  # Formato decimal
...
=======
                ...
                for row in range(2, worksheet.max_row + 1):
                    for col in range(1, worksheet.max_column + 1):
                        ...
                        # Aplicar formatação apenas na coluna TDH, não em Frota ou Frente
                        if header == 'TDH':
                ...
                for row in range(2, worksheet.max_row + 1):
                    for col in range(1, worksheet.max_column + 1):
                        ...
                        # Aplicar formatação apenas na coluna Diesel, não em Frota ou Frente
                        if header == 'Diesel':
                            cell.number_format = '0.0000'  # 4 casas decimais
                ...
                for row in range(2, worksheet.max_row + 1):
                    for col in range(1, worksheet.max_column + 1):
                        ...
                        # Aplicar formatação apenas na coluna Impureza, não em Frota ou Frente
                        if header == 'Impureza':
